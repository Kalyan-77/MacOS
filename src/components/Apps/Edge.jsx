...
// import { X, ChevronLeft, ChevronRight, RotateCcw, Home, Star, MoreHorizontal, Shield, Settings, User, Search, Clock, Bookmark, Globe, TrendingUp } from 'lucide-react';
...
//                   {link.icon}
//                 </div>
//                 <span className="text-sm text-gray-700 text-center font-medium">{link.name}</span>
//               </button>
//             ))}
//           </div>
//         </div>
...
//               <div className="text-3xl font-light text-gray-800 mb-1">22°C</div>
//               <div className="text-sm text-gray-600 mb-4">Sunny • Phagwara, Punjab</div>
//               <div className="grid grid-cols-4 gap-2 text-center">
//                 <div className="p-2">
//                   <div className="text-xs text-gray-500 mb-1">Mon</div>
//                   <div className="text-lg">🌤️</div>
//                   <div className="text-xs text-gray-800">24°/18°</div>
//                 </div>
//                 <div className="p-2">
//                   <div className="text-xs text-gray-500 mb-1">Tue</div>
//                   <div className="text-lg">⛅</div>
//                   <div className="text-xs text-gray-800">21°/16°</div>
//                 </div>
//                 <div className="p-2">
//                   <div className="text-xs text-gray-500 mb-1">Wed</div>
//                   <div className="text-lg">🌧️</div>
//                   <div className="text-xs text-gray-800">19°/14°</div>
//                 </div>
//                 <div className="p-2">
//                   <div className="text-xs text-gray-500 mb-1">Thu</div>
//                   <div className="text-lg">☀️</div>
//                   <div className="text-xs text-gray-800">25°/19°</div>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//   // Dragging system - identical to calendar
...
//   // Initialize dragging system - same as calendar
//   useEffect(() => {
...
//   // Traffic light handlers - same as calendar
//   const handleClose = () => {
//     onClose();
//   };
...
//         height: isMaximized ? 'calc(100vh - 25px)' : '620px',
...
//           <h1 className="text-sm font-medium text-gray-700">Microsoft Edge</h1>
//         </div>
...
//           {/* Edge Actions */}
//           <div className="flex items-center gap-1">
//             <button className="p-2 hover:bg-gray-200 rounded-md transition-colors text-gray-700" style={{ cursor: 'pointer' }}>
//               <Star size={20} />
//             </button>
//             <button className="p-2 hover:bg-gray-200 rounded-md transition-colors text-gray-700" style={{ cursor: 'pointer' }}>
...
//                     className="mt-4 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors pointer-events-auto"
//                   >
//                     Open in new window
//                   </button>
//                 </div>
